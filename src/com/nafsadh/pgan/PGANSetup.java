...
public class PGANSetup {
    ...
    //region existingSetup
    static String existingSetup =
                      "Venusaur: 95%+, L25+\n"
                    + "Charizard: 95%+, L23+\n"
                    + "Squirtle: 95%+, L23+\n"
                    + "Wartortle: 95%+, L25+\n"
    ...
    static final int dIV  = 99;
    static final int lvl  = 29;
    ...
    public static void printPrefInitForm() {
    ...
    private static void interpretCurrentPref(Map<String, Pref> map) {
        ...
        String[] setupLines = existingSetup.split("\n");
            ...
            if (split.length == 2) {
                ...
                if (pref == null) {
                    ...
                    if (split[1].contains("All") || split[1].contains("all")) {
                        ...
                        if (ivl.length != 2) {
                            System.err.printf("Bad IV/Level in " + pokemon);
                        } else {
